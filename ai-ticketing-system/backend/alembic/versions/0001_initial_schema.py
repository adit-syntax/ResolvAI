...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column('skill_tags', sa.Text(), server_default='', nullable=True),
        sa.Column('avg_resolution_time', sa.Float(), server_default='0.0', nullable=True),
    ...
    op.create_table(
        ...
        sa.Column('category', sa.String(length=20), index=True, nullable=True),
        sa.Column('ai_summary', sa.Text(), nullable=True),
        sa.Column('severity', sa.String(length=20), server_default='Medium', nullable=False),
        sa.Column('recommended_resolution_path', sa.String(length=30), nullable=True),
        sa.Column('sentiment', sa.String(length=20), nullable=True),
        sa.Column('suggested_department', sa.String(length=50), nullable=True),
    ...
    op.create_table(
        ...
        sa.Column('is_employee_reply', sa.Boolean(), server_default=sa.text('true'), nullable=False),
